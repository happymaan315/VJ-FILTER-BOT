...
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '1462396507').split()] # No use 
...
URL = "https://vj-filter-bot-kvzd.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://vj-filter-bot-kvzd.onrender.com/".format(FQDN, PORT)
