...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://taransaini2007:Maanjatt@1@cluster0.qvorjcz.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
URL = "https://vj-filter-bot-qoou.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://vj-filter-bot-qoou.onrender.com/".format(FQDN, PORT)
