...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Free:Maanjatt@1@cluster0.lcgdxz1.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
URL = "https://vj-filter-bot-oo41.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://vj-filter-bot-oo41.onrender.com/".format(FQDN, PORT)
